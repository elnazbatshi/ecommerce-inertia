...
const form = useForm({ name: '', slug: '', code: '', sort_order: 0, is_active: true });
const save = () => form.post('/admin/provinces', { preserveScroll: true });
</script>

<template>
    <Head title="ایجاد استان" />
    <AppLayout>
        <TopNavTitle title="ایجاد استان" :breadcrumb="[{ label: 'استان‌ها', to: '/admin/provinces' }, { label: 'ایجاد' }]" />
        <div class="card">
